    ...
    return(
        <ContactInfoContainer>
            ...
            <DataContainer>
                ...
                <SubHeaders>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#21e521" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="10" r="3"/><path d="M12 21.7C17.3 17 20 13 20 10a8 8 0 1 0-16 0c0 3 2.7 6.9 8 11.7z"/></svg>
                    <a href="https://www.google.com/maps/@52.4235383,16.8908661,12z?entry=ttu">Poznań/Poland</a>
                </SubHeaders>
                <SubHeaders>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#21e521" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                    <a href="mailto:pio1kostecki@gmail.com">pio1kostecki@gmail.com</a>
                </SubHeaders>
                <SubHeaders>
                    <svg width="40px" height="40px" stroke="#21e521" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://github.com/KaleIsProgramming">KaleIsProgramming</a>
                </SubHeaders>
            </DataContainer>
